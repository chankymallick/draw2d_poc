...
TableShape = draw2d.shape.layout.VerticalLayout.extend({
    ...
    init: function (attr) {
        ...
        var img2 = new draw2d.shape.icon.Expand({ minWidth: 20, minHeight: 20, width: 20, height: 20, visible: true });
    ...
    addEntity: function (txt, optionalIndex) {
        var label = new draw2d.shape.basic.Label({
            ...
            fontSize: 16,
            bgColor: null,
            padding: { left: 20, top: 3, right: 20, bottom: 5 },
            fontColor: "#4a4a4a",
            resizeable: true
    ...
    onClick: function(ww,ff){
    	alert(1)
    }


});
// TableShape.on("dblclick", function(emitter, event){
